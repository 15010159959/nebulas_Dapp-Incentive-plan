jQuery(function(t){var e=function(){var e="/api/registerEmail",a=function(){var e=(/MSIE (\d+)\./.exec(navigator.userAgent)||[0,0])[1]
...
return i&&(i.call(this,o),"pending"!=o.state())?o:(a(e,{type:"POST",data:{email:$("[name='email']").val()}}).done(function(t){try{var e=t;
e.error?o.reject(e.error):o.resolve(e.response)}catch(a){o.reject("Incorrect server response.")
}}).fail(function(){var t="Failed to query the server. "
